...
namespace My.Crypt
{
    ...
    public class Md5
    {
        ...
        public string StringValue
        {
            ...
            {
                string st;
                var tempCharArray = new char[_byteInput.Length];

                for (int i = 0; i < _byteInput.Length; i++)
                    tempCharArray[i] = (char)_byteInput[i];
            ...
            set
            {
                ...
                OnValueChanging?.Invoke(this, new MD5ChangingEventArgs(value));
                ...
                OnValueChanged?.Invoke(this, new MD5ChangedEventArgs(value, _digest.ToHexString()));
            }
        }
        ...
        public byte[] BytesValue
        {
            get
            {
                var bt = new byte[_byteInput.Length];
                for (int i = 0; i < _byteInput.Length; i++)
                    bt[i] = _byteInput[i];
                return bt;
            }
